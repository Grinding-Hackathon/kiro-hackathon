...
#ifndef OFFLINEBLOCKCHAINWALLET_SWIFT_H
#define OFFLINEBLOCKCHAINWALLET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OfflineBlockchainWallet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC23OfflineBlockchainWallet16BluetoothService")
...
@interface BluetoothService (SWIFT_EXTENSION(OfflineBlockchainWallet)) <CBCentralManagerDelegate>
